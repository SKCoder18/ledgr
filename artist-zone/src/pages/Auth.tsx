    ...
    <div className="min-h-screen flex items-center justify-center px-6 py-12">
      <div className="w-full max-w-md animate-fade-in">
        ...
        <form onSubmit={handle} className="space-y-4">
          ...
          <Button type="submit" disabled={busy || googleBusy} variant="hero" size="lg" className="w-full mt-6 shadow-glow-primary">
        ...
        <Button
          ...
          variant="outline"
          size="lg"
          className="w-full h-12 gap-3 font-medium bg-surface-2 hover:bg-surface-3 transition-all"
