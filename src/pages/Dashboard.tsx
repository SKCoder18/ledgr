...
const Dashboard = () => {
  ...
  return (
    <div className="min-h-screen pb-20">
      ...
      <div className="container max-w-6xl pt-10 md:pt-16 space-y-10">
        {/* Hero greeting */}
        <section className="animate-fade-in">
          ...
          <h1 className="text-4xl md:text-5xl font-display font-bold leading-[1.05] tracking-tight">
            Hi {profile?.display_name || "there"}, <br className="hidden sm:block" />
        ...
        <div className="grid lg:grid-cols-5 gap-6">
          <div className="lg:col-span-3"><AddExpense onAdded={handleAdded} defaultCurrency={currency} /></div>
        ...
        {/* Recent */}
        <RecentExpenses expenses={expenses} currency={currency} onDelete={handleDelete} />
      </div>
    </div>
  );
};
